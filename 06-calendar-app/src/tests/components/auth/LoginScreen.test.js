...
describe('Pruebas en <LoginScreen />', () => {
     ...
     test('debe de llamar el dispatch del login', () => {
          ...
          expect( startLogin ).toHaveBeenCalledWith('biel@gmail.com', '123456');
     ...
     test('Registro con contraseñas iguales', () => {
          ...
          expect( startRegister ).toHaveBeenCalledWith('biana@gmail.com', '123456', 'Biana');
